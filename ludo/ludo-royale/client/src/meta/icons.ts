/**
 * Inline SVG icon set for the overlay chrome — all FILLED style (STYLE-GUIDE
 * "filled-rounded, never mix filled/outline"). Path data from Material Icons
 * (Apache-2.0). Rendered as inline <svg fill="currentColor"> so color rides
 * the CSS `color` property. Rich PNG replacements have §8 slots (`nav_*`).
 */
...
const PATHS = {
  ...
  shop:
    'M18 6h-2c0-2.21-1.79-4-4-4S8 3.79 8 6H6c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm-6-2c1.1 0 2 .9 2 2h-4c0-1.1.9-2 2-2zm0 10c-2.76 0-5-2.24-5-5h2c0 1.65 1.35 3 3 3s3-1.35 3-3h2c0 2.76-2.24 5-5 5z',
...
export function svgIcon(name: IconName, className = 'lr-icon'): SVGSVGElement {
