...
assert(str_contains($js, 'Number(wallet.minBet)'), 'min stake does not use site setting');
...
assert(str_contains($php, "setting('min_bet_amount')"), 'server min does not use site setting');
...
assert(str_contains($js, 'dir * minInr()'), '+/- does not step by configured minimum');
